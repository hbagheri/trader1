---
title: "پرتوزایی و نیمه‌عمر — ساعتی که در دلِ اتم می‌تپد ⏳"
chapter: "فصل ۶ — آشنایی با فیزیک هسته‌ای"
section: "۶-۲ پرتوزایی طبیعی و نیمه‌عمر"
order: 2
slug: "y12-partozayi-nimeomr"
level: "دوازدهم ریاضی و فیزیک"
reading_time: "حدود ۱۸ دقیقه"
keywords: ["پرتوزایی", "نیمه‌عمر", "آلفا", "بتا", "گاما", "واپاشی", "کربن-۱۴", "بکرل", "ماری کوری", "دوازدهم"]
---
...
- $\bar\nu_e$ یه ذره‌ی خیلی سبک و بی‌بار به اسمِ **پاد‌نوترینو**ست (در کتاب گاهی ذکر نمی‌شه، ولی وجود داره).
- بار: $-e$، جرم: بسیار کم
...
<iframe src="/widgets/alpha-beta-gamma.html" width="100%" height="540" style="border:none; border-radius:12px;" loading="lazy" title="نفوذ پرتوهای آلفا/بتا/گاما"></iframe>

> 🎬 **ویدیوی پیشنهادی وسطِ درس**: «What Is Radiation?» از Veritasium — [یوتیوب](https://www.youtube.com/results?search_query=veritasium+radiation+alpha+beta+gamma) | و آپارات: [«آلفا بتا گاما»](https://www.aparat.com/result/%D9%BE%D8%B1%D8%AA%D9%88%20%D8%A2%D9%84%D9%81%D8%A7%20%D8%A8%D8%AA%D8%A7%20%DA%AF%D8%A7%D9%85%D8%A7). شبیه‌سازِ PhET هم برای واپاشی آلفا داره: [PhET — Alpha Decay (فارسی)](https://phet.colorado.edu/fa/simulations/alpha-decay) و [Beta Decay](https://phet.colorado.edu/fa/simulations/beta-decay).
...
$$
A_\text{قبل} = A_\text{بعد}, \quad Z_\text{قبل} = Z_\text{بعد}
$$

**مثالِ تمرینی:**
$${}^{226}_{\;88}\text{Ra} \longrightarrow {}^{222}_{\;86}\text{Rn} + ?$$
...
> 🇮🇷 جستجوی [آپارات — شمارنده گایگر](https://www.aparat.com/result/%D8%B4%D9%85%D8%A7%D8%B1%D9%86%D8%AF%D9%87%20%DA%AF%D8%A7%DB%8C%DA%AF%D8%B1) — کلیپ‌های واقعی از کارش.
...
<iframe src="/widgets/radioactive-decay.html" width="100%" height="640" style="border:none; border-radius:12px;" loading="lazy" title="شبیه‌ساز نیمه‌عمر"></iframe>

> 🎮 **بازی با همین مفهوم در PhET:** [Radioactive Dating Game](https://phet.colorado.edu/fa/simulations/radioactive-dating-game) — سن‌سنجیِ فسیل، سنگ، حتی درخت با کربن-۱۴.

## ۵) محاسبه‌ها — چند مثالِ کلیدی 🧮

### مثال ۱: نمونه‌ی ساده

اگه $80\,\text{g}$ کبالت-۶۰ داشته باشیم ($T_{1/2} = 5.27\,\text{سال}$)، بعد از $15.81\,\text{سال}$ چقدر می‌مونه؟
...
$$t = 5730 \times \dfrac{0.523}{0.301} \approx 9956\,\text{سال}$$

پس استخوان حدودِ **۱۰ هزار ساله**ست — مثلاً از انسانِ نئاندرتالِ آخر.
...
> 🎓 **برای علاقه‌مند**: [Khan Academy — Radiometric dating](https://www.khanacademy.org/science/biology/her/tree-of-life/v/radiometric-dating) | و [NOAA — How is Carbon Dating Used](https://www.noaa.gov/explainers/carbon-dating).
...
اگه پایتون نداری، رایگان روی [Colab](https://colab.research.google.com) باز کن، paste کن، اجرا.
...
- [MIT OpenCourseWare — Radiation](https://ocw.mit.edu/search/?q=radiation)
- [Khan Academy — Half-life](https://www.khanacademy.org/science/physics/quantum-physics/in-in-nuclei/v/half-life-plot)
- [Khan Academy — Radioactive Decay Types](https://www.khanacademy.org/science/chemistry/nuclear-chemistry/radioactive-decay/a/types-of-decay)
- [HyperPhysics — Radioactive Decay](http://hyperphysics.phy-astr.gsu.edu/hbase/Nuclear/radact.html)
...
- [IAEA — Radioactivity](https://www.iaea.org/topics/radioactivity)
- [Wikipedia فارسی — پرتوزایی](https://fa.wikipedia.org/wiki/%D9%BE%D8%B1%D8%AA%D9%88%D8%B2%D8%A7%DB%8C%DB%8C) | [EN — Radioactive decay](https://en.wikipedia.org/wiki/Radioactive_decay)
- [Wikipedia EN — Half-life](https://en.wikipedia.org/wiki/Half-life) | [Carbon-14 dating](https://en.wikipedia.org/wiki/Radiocarbon_dating)

### 🎬 ویدیو و یوتیوب
- [Veritasium — Radiation](https://www.youtube.com/results?search_query=veritasium+radiation)
- [Veritasium — The Most Radioactive Places on Earth](https://www.youtube.com/results?search_query=veritasium+most+radioactive+places)
- [Kurzgesagt — Death From Space (Gamma)](https://www.youtube.com/results?search_query=kurzgesagt+gamma+ray)
- [PBS Space Time — Radioactive decay](https://www.youtube.com/results?search_query=pbs+space+time+radioactive)
- [MinutePhysics — Half-life](https://www.youtube.com/results?search_query=minutephysics+half+life)
- [SciShow — Marie Curie](https://www.youtube.com/results?search_query=scishow+marie+curie)

### 🇮🇷 آپارات
- [پرتوزایی آلفا بتا گاما](https://www.aparat.com/result/%D9%BE%D8%B1%D8%AA%D9%88%D8%B2%D8%A7%DB%8C%DB%8C%20%D8%A2%D9%84%D9%81%D8%A7%20%D8%A8%D8%AA%D8%A7%20%DA%AF%D8%A7%D9%85%D8%A7)
- [نیمه عمر فیزیک](https://www.aparat.com/result/%D9%86%DB%8C%D9%85%D9%87%20%D8%B9%D9%85%D8%B1%20%D9%81%DB%8C%D8%B2%DB%8C%DA%A9)
- [سن سنجی کربن ۱۴](https://www.aparat.com/result/%D8%B3%D9%86%20%D8%B3%D9%86%D8%AC%DB%8C%20%DA%A9%D8%B1%D8%A8%D9%86%2014)
...
- [Isotopes and Atomic Mass — فارسی](https://phet.colorado.edu/fa/simulations/isotopes-and-atomic-mass)

### 🐍 کدِ پایتون / نوت‌بوک
- مثالِ [scipy decay model](https://docs.scipy.org/doc/scipy/tutorial/integrate.html) برای حلِ معادله‌ی دیفرانسیلی
- [Colab](https://colab.research.google.com) برای اجرای کدِ بالا
- داده‌های واقعی: [NNDC — Nuclear Data](https://www.nndc.bnl.gov/nudat3/)

### 📖 کورس‌های رایگان
- [edX — Nuclear Energy: Science, Systems and Society (MIT)](https://www.edx.org/learn/nuclear-engineering)
- [Coursera — Nuclear Reactor Physics](https://www.coursera.org/search?query=nuclear+reactor+physics)
- [OpenStax — College Physics, Chapter on Radioactivity](https://openstax.org/books/college-physics-2e/pages/31-introduction-to-radioactivity-and-nuclear-physics)
