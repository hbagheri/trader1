---
title: "ساختار هسته — قلبِ کوچکی که جهان رو نگه داشته 💥"
chapter: "فصل ۶ — آشنایی با فیزیک هسته‌ای"
section: "۶-۱ ساختار هسته"
order: 1
slug: "y12-sakhtar-haste"
level: "دوازدهم ریاضی و فیزیک"
reading_time: "حدود ۱۴ دقیقه"
keywords: ["هسته", "پروتون", "نوترون", "ایزوتوپ", "انرژی بستگی", "نقص جرم", "فیزیک هسته‌ای", "دوازدهم"]
---
...
<!-- INTERACTIVE: nuclear-binding-energy.html — منحنی انرژی بستگی به ازای نوکلئون -->
<iframe src="/widgets/nuclear-binding-energy.html" width="100%" height="640" style="border:none; border-radius:12px;" loading="lazy" title="منحنی انرژی بستگی به ازای نوکلئون"></iframe>
...
$$
{}^{12}_{\;6}\text{C} \quad \Rightarrow \quad Z = 6 \text{ پروتون}, \; N = 12-6 = 6 \text{ نوترون}
$$

$$
{}^{235}_{\;\;92}\text{U} \quad \Rightarrow \quad 92 \text{ پروتون و } 143 \text{ نوترون}
$$

> 🎬 یه ویدیویِ کوتاه و درخشانِ از MinutePhysics دربارهٔ ساختار هسته اگه دوست داری: [«Atoms vs the Atomic Bomb» (یوتیوب)](https://www.youtube.com/results?search_query=minutephysics+atomic+nucleus). و اگه می‌خوای دستی با اتم‌ها بازی کنی، شبیه‌سازِ **Build an Atom** از PhET سرتاپا برای همینه: [PhET — Build an Atom (فارسی)](https://phet.colorado.edu/fa/simulations/build-an-atom).
...
| عنصر | ایزوتوپ‌ها | $Z$ | $N$ |
|---|---|---|---|
| هیدروژن | ${}^{1}_{1}\text{H}$ (پروتیوم), ${}^{2}_{1}\text{H}$ (دوتریوم D), ${}^{3}_{1}\text{H}$ (تریتیوم T) | ۱ | ۰، ۱، ۲ |
...
اگه پایتون نداری، آنلاین رو [Google Colab](https://colab.research.google.com) یا [replit.com](https://replit.com) امتحان کن — رایگانه و در مرورگر اجرا می‌شه.
...
<!-- INTERACTIVE: nuclear-binding-energy.html — هَوِر کن روی هسته‌ها -->
...
> 🎥 **مرور بصری عالی:** ویدیویِ «Why E=mc² explains nuclear power» از Veritasium — جستجو در [یوتیوب](https://www.youtube.com/results?search_query=veritasium+nuclear+binding+energy) / [آپارات](https://www.aparat.com/result/veritasium%20nuclear%20binding). و اگه می‌خوای رسمیت بیشتر، [MIT OCW 22.01 — Introduction to Nuclear Engineering](https://ocw.mit.edu/courses/22-01-introduction-to-nuclear-engineering-and-ionizing-radiation-fall-2016/) رایگان آنلاینه.
...
طلایِ گردنبندِ مادربزرگت؟ ۸ میلیارد سالِ پیش در یه ابرنواخترِ بعید ساخته شده. اگه می‌خوای جزئیاتش رو بدونی، [NASA — Origin of the Elements](https://imagine.gsfc.nasa.gov/science/objects/supernovae1.html) یا یه ویدیویِ ۶ دقیقه‌ای از PBS Space Time: [«Where Did the Heavy Elements Come From?»](https://www.youtube.com/results?search_query=pbs+space+time+heavy+elements).
...
🧠 **چادویک چطور نوترون رو پیدا کرد؟** اون بمبارانِ بریلیوم با ذره‌ی آلفا انجام داد و دید یه ذره‌ی خنثی با جرمِ تقریباً برابرِ پروتون از بریلیوم خارج می‌شه. ایده‌اش رو از یه پیشنهادِ ۱۲ ساله‌ی رادرفورد گرفت! [مقاله‌ی نوبلِ ۱۹۳۵ چادویک](https://www.nobelprize.org/prizes/physics/1935/chadwick/lecture/) (انگلیسی).
...
### 📚 آکادمیک و دانشگاهی
- [MIT OCW 22.01 — Introduction to Nuclear Engineering and Ionizing Radiation](https://ocw.mit.edu/courses/22-01-introduction-to-nuclear-engineering-and-ionizing-radiation-fall-2016/) (رایگان، انگلیسی، با ویدیو)
- [MIT OCW 8.701 — Introduction to Nuclear and Particle Physics](https://ocw.mit.edu/search/?q=8.701) — سطحِ بالاتر، برای علاقمندان
- [Khan Academy — Nuclear Chemistry](https://www.khanacademy.org/science/chemistry/nuclear-chemistry) (با زیرنویسِ فارسی در بعضی ویدیوها)
- [HyperPhysics — Nuclear Structure](http://hyperphysics.phy-astr.gsu.edu/hbase/Nuclear/nucstr.html)
- [NASA — Origin of the Elements](https://imagine.gsfc.nasa.gov/science/objects/supernovae1.html)
- [Wikipedia فارسی — هسته اتم](https://fa.wikipedia.org/wiki/%D9%87%D8%B3%D8%AA%D9%87_%D8%A7%D8%AA%D9%85) | [Wikipedia EN — Atomic nucleus](https://en.wikipedia.org/wiki/Atomic_nucleus)
- [Wikipedia — Nuclear binding energy](https://en.wikipedia.org/wiki/Nuclear_binding_energy)

### 🎬 ویدیو و یوتیوب
- جستجوی [Veritasium — Nuclear binding energy / E=mc²](https://www.youtube.com/results?search_query=veritasium+nuclear+binding+energy)
- جستجوی [PBS Space Time — Heavy Elements](https://www.youtube.com/results?search_query=pbs+space+time+heavy+elements)
- جستجوی [3Blue1Brown — Quantum and atoms](https://www.youtube.com/results?search_query=3blue1brown+atoms)
- جستجوی [MinutePhysics — Atomic nucleus](https://www.youtube.com/results?search_query=minutephysics+atomic+nucleus)

### 🇮🇷 آپارات
- جستجوی [ساختار هسته اتم](https://www.aparat.com/result/%D8%B3%D8%A7%D8%AE%D8%AA%D8%A7%D8%B1%20%D9%87%D8%B3%D8%AA%D9%87)
- جستجوی [انرژی بستگی هسته](https://www.aparat.com/result/%D8%A7%D9%86%D8%B1%DA%98%DB%8C%20%D8%A8%D8%B3%D8%AA%DA%AF%DB%8C%20%D9%87%D8%B3%D8%AA%D9%87)

### 🎮 شبیه‌سازِ تعاملی PhET
- [Build an Atom — فارسی](https://phet.colorado.edu/fa/simulations/build-an-atom) — اتم‌سازی با پروتون/نوترون/الکترون
- [Isotopes and Atomic Mass — فارسی](https://phet.colorado.edu/fa/simulations/isotopes-and-atomic-mass)
- [Rutherford Scattering — فارسی](https://phet.colorado.edu/fa/simulations/rutherford-scattering)

### 🐍 کدِ پایتون / نوت‌بوک
- [Google Colab](https://colab.research.google.com) — کدِ پایتون رو رایگان و آنلاین اجرا کن
- [replit.com](https://replit.com) — IDE آنلاین
- ماژولِ [ENSDF data](https://www.nndc.bnl.gov/ensdf/) از NNDC برای داده‌های واقعیِ هسته‌ای

### 📖 کورس‌های رایگان
- [edX — Nuclear Energy: Science, Systems and Society (MIT)](https://www.edx.org/learn/nuclear-engineering)
- [Coursera — Nuclear Reactor Engineering](https://www.coursera.org/search?query=nuclear+reactor)
