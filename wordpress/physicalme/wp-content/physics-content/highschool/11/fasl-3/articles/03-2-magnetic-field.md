---
title: "میدان مغناطیسی — جایی که نیرو زندگی می‌کنه 🌐"
chapter: "فصل ۳ — مغناطیس"
section: "۳-۲ میدان مغناطیسی"
order: 2
slug: "y11-magnetic-field"
level: "یازدهم ریاضی و فیزیک"
reading_time: "حدود ۱۵ دقیقه"
keywords: ["میدان مغناطیسی", "تسلا", "گاوس", "خطوط میدان", "میدان زمین", "شفق قطبی", "شیب مغناطیسی", "یازدهم", "فصل ۳"]
---
...
- **جهت**ش = جهتی که قطبِ N سوزنِ قطب‌نما اشاره می‌کنه
- **اندازه**ش = اینکه میدان «چقدر قویه»، یا چقدر نیرو روی واحدِ بارِ متحرک وارد می‌کنه (تو زیرفصلِ بعدی فرمولش رو می‌بینیم)
...
<iframe src="/widgets/magnetic-field-explorer.html" width="100%" height="650"
        style="border:none; border-radius:12px;" loading="lazy"
        title="کاوش میدان مغناطیسی"></iframe>
...
تسلا یه یکای **خیلی بزرگ**ـه. مثلاً میدان مغناطیسیِ زمین، که خیلی محسوسه و قطب‌نما رو می‌چرخونه، فقط حدوداً ۵۰ میکروتسلا (۵۰ μT) ـه — یعنی $5\times 10^{-5}$ تسلا.

### مقیاسِ بزرگیِ میدان‌های مغناطیسی 🌌

این جدولِ کوچک حسّت رو نسبت به مقدارهای واقعی تنظیم می‌کنه:

<div style="background:#FBF6E3; border:1px solid #E4D9A9; border-radius:12px; padding:14px 16px; margin:18px auto; max-width:620px; font-size:14.5px; line-height:1.9;">
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">10<sup>-12</sup> T</span>
    <span style="display:inline-block; width:60px; height:10px; background:linear-gradient(to left, #d6453c 5%, #fce5e5 95%); border-radius:99px;"></span>
    <span style="flex:1;">میدانِ مغزِ انسان (MEG)</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">10<sup>-10</sup> T</span>
    <span style="display:inline-block; width:80px; height:10px; background:linear-gradient(to left, #d6453c 15%, #fce5e5 85%); border-radius:99px;"></span>
    <span style="flex:1;">میدانِ قلبِ انسان</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">~50 μT</span>
    <span style="display:inline-block; width:100px; height:10px; background:linear-gradient(to left, #d6453c 35%, #fce5e5 65%); border-radius:99px;"></span>
    <span style="flex:1;">میدانِ مغناطیسی زمین</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">~5 mT</span>
    <span style="display:inline-block; width:140px; height:10px; background:linear-gradient(to left, #d6453c 50%, #fce5e5 50%); border-radius:99px;"></span>
    <span style="flex:1;">آهنربای یخچال</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">~1 T</span>
    <span style="display:inline-block; width:180px; height:10px; background:linear-gradient(to left, #d6453c 70%, #fce5e5 30%); border-radius:99px;"></span>
    <span style="flex:1;">آهنربایِ قویِ نئودیمیوم (آهنربای بلندگو)</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">1.5–7 T</span>
    <span style="display:inline-block; width:220px; height:10px; background:linear-gradient(to left, #d6453c 82%, #fce5e5 18%); border-radius:99px;"></span>
    <span style="flex:1;">MRI پزشکی</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">~10<sup>3</sup> T</span>
    <span style="display:inline-block; width:280px; height:10px; background:linear-gradient(to left, #d6453c 92%, #fce5e5 8%); border-radius:99px;"></span>
    <span style="flex:1;">قوی‌ترین آهنربای پالسی آزمایشگاهی</span>
  </div>
  <div style="display:flex; align-items:center; gap:12px; padding:6px 0;">
    <span style="display:inline-block; width:80px; text-align:left; font-family:monospace; font-size:13px; color:#a87800; font-weight:700;">10<sup>11</sup> T</span>
    <span style="display:inline-block; width:340px; height:10px; background:#d6453c; border-radius:99px;"></span>
    <span style="flex:1;">ستارهٔ مگنتار 🤯 (قوی‌ترین در کیهان)</span>
  </div>
</div>
...
<div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(240px,1fr)); gap:14px; margin:18px 0;">
  <div style="background:#e6f1fb; border-right:4px solid #185fa5; padding:14px; border-radius:10px;">
    <b style="color:#185fa5; display:block; margin-bottom:6px;">۱) همیشه حلقهٔ بسته‌ان</b>
  ...
  <div style="background:#e6f1fb; border-right:4px solid #185fa5; padding:14px; border-radius:10px;">
    <b style="color:#185fa5; display:block; margin-bottom:6px;">۲) هیچ‌وقت همدیگه رو قطع نمی‌کنن</b>
    اگه دو خط از یه نقطه می‌گذشتن، اون نقطه دو جهتِ میدان داشت. این بی‌معنی‌ست — هر نقطه فقط **یه** جهتِ میدان داره.
  </div>
  <div style="background:#e6f1fb; border-right:4px solid #185fa5; padding:14px; border-radius:10px;">
    <b style="color:#185fa5; display:block; margin-bottom:6px;">۳) چگالی = شدّت میدان</b>
    هرجا خطوط نزدیک‌تر و متراکم‌ترن، میدان قوی‌تره. به‌همین خاطر نزدیکِ قطب‌ها خطوط فشرده‌ان.
  </div>
  <div style="background:#e6f1fb; border-right:4px solid #185fa5; padding:14px; border-radius:10px;">
    <b style="color:#185fa5; display:block; margin-bottom:6px;">۴) جهت‌شون مشخصه</b>
    بیرونِ آهنربا: از <span style="color:#d6453c;font-weight:700">N</span> به <span style="color:#2f6fd0;font-weight:700">S</span>. داخلِ آهنربا: از <span style="color:#2f6fd0;font-weight:700">S</span> به <span style="color:#d6453c;font-weight:700">N</span> — تا حلقه‌ها بسته بشن.
  </div>
</div>

<figure>
  <img src="/images/03-1-bar-magnet-iron-filings.jpg"
       alt="خطوط میدان نمایان‌شده با برادهٔ آهن"
       loading="lazy"
       style="width:100%; max-width:560px; height:auto; border-radius:12px; display:block; margin:14px auto;">
...
<div style="display:flex; justify-content:center; align-items:center; gap:24px; flex-wrap:wrap; background:#f4f3ef; border:1px solid #e0ded7; border-radius:12px; padding:20px; margin:14px 0;">
  <svg viewBox="0 0 260 130" style="max-width:260px; height:auto;" aria-hidden="true">
    <defs>
      <marker id="arrU" viewBox="0 0 10 10" refX="5" refY="3" markerWidth="6" markerHeight="6" orient="auto">
        <path d="M0,0 L10,3 L0,6 Z" fill="#185fa5"/>
      </marker>
    </defs>
    <rect x="2" y="2" width="256" height="126" fill="none" stroke="#bbb" stroke-dasharray="3,3" rx="4"/>
    <line x1="20"  y1="118" x2="20"  y2="14" stroke="#185fa5" stroke-width="2" marker-end="url(#arrU)"/>
    <line x1="60"  y1="118" x2="60"  y2="14" stroke="#185fa5" stroke-width="2" marker-end="url(#arrU)"/>
    <line x1="100" y1="118" x2="100" y2="14" stroke="#185fa5" stroke-width="2" marker-end="url(#arrU)"/>
    <line x1="140" y1="118" x2="140" y2="14" stroke="#185fa5" stroke-width="2" marker-end="url(#arrU)"/>
    <line x1="180" y1="118" x2="180" y2="14" stroke="#185fa5" stroke-width="2" marker-end="url(#arrU)"/>
    <line x1="220" y1="118" x2="220" y2="14" stroke="#185fa5" stroke-width="2" marker-end="url(#arrU)"/>
    <text x="130" y="128" font-size="11" fill="#888" text-anchor="middle" font-family="Vazirmatn">میدان یکنواخت: همه‌جا یک‌جوره</text>
  </svg>
</div>
...
<figure>
  <img src="/images/03-2-earth-field.png"
       alt="میدان مغناطیسی زمین به شکلِ دوقطبیِ کج"
       loading="lazy"
       style="width:100%; max-width:480px; height:auto; border-radius:12px; display:block; margin:14px auto;">
  <figcaption style="text-align:center; font-size:13px; color:#666; margin-top:8px;">
    زمین مثل یه آهنربای میله‌ای غول‌پیکر رفتار می‌کنه. محورش با محور چرخش زمین حدود ۱۱ درجه اختلاف داره. منبع: <a href="https://commons.wikimedia.org/wiki/File:Earth%27s_magnetic_field,_schematic.png" target="_blank" rel="noopener">Wikimedia Commons</a>
  </figcaption>
</figure>
...
<figure>
  <img src="/images/03-2-aurora-iss.jpg"
       alt="شفق قطبی جنوبی از ایستگاه فضایی بین‌المللی"
       loading="lazy"
       style="width:100%; max-width:640px; height:auto; border-radius:12px; display:block; margin:14px auto;">
  <figcaption style="text-align:center; font-size:13px; color:#666; margin-top:8px;">
    شفقِ قطبیِ جنوبی (Aurora Australis) از دیدِ ایستگاه فضایی بین‌المللی. ذراتِ پرانرژیِ خورشیدی، در امتدادِ خطوطِ میدان زمین به قطب کشیده می‌شن و با جوّ برخورد می‌کنن. منبع: NASA / <a href="https://commons.wikimedia.org/wiki/File:Aurora_Australis_From_ISS.JPG" target="_blank" rel="noopener">Wikimedia Commons</a>
  </figcaption>
</figure>
...
<iframe src="/widgets/magnetic-field-quiz.html" width="100%" height="780"
        style="border:none; border-radius:12px;" loading="lazy"
        title="پرسش‌های خودسنجی میدان مغناطیسی"></iframe>
