---
title: "پایستگیِ انرژیِ مکانیکی — قانونِ زیبایِ طبیعت 🎢⚖️"
chapter: "فصل ۳ — کار، انرژی و توان (تجربی)"
section: "۳-۵ پایستگی انرژی مکانیکی"
order: 5
slug: "conservation-of-mechanical-energy-tajrobi"
level: "دهم تجربی"
reading_time: "حدود ۴ دقیقه"
keywords: ["پایستگی انرژی", "انرژی مکانیکی", "پاندول", "ترن هوایی", "تجربی"]
---
...
<iframe src="/wp-content/physics-content/highschool/10/widgets/energy-conservation.html" width="100%" height="540" style="border:none; border-radius:12px;" loading="lazy" title="پایستگی انرژی پاندول"></iframe>
...
### مقالات
- ویکی‌پدیای فارسی: [پایستگی انرژی](https://fa.wikipedia.org/wiki/%D9%82%D8%A7%D9%86%D9%88%D9%86_%D9%BE%D8%A7%DB%8C%D8%B3%D8%AA%DA%AF%DB%8C_%D8%A7%D9%86%D8%B1%DA%98%DB%8C)
- Wikipedia EN: [Conservation of energy](https://en.wikipedia.org/wiki/Conservation_of_energy)، [Mechanical energy](https://en.wikipedia.org/wiki/Mechanical_energy)
- [HyperPhysics — Conservation of energy](http://hyperphysics.phy-astr.gsu.edu/hbase/conser.html)

### ویدئو (یوتیوب)
- Veritasium: [The most beautiful idea in physics — Noether's Theorem](https://www.youtube.com/results?search_query=veritasium+noether+conservation+energy)
- MIT OCW 8.01: [Conservation of mechanical energy](https://www.youtube.com/results?search_query=walter+lewin+conservation+energy)
- 3Blue1Brown: [Why every conservation law exists](https://www.youtube.com/results?search_query=3blue1brown+conservation+law)

### ویدئو (آپارات — فارسی)
- [جست‌وجو: پایستگی انرژی مکانیکی](https://www.aparat.com/result/%D9%BE%D8%A7%DB%8C%D8%B3%D8%AA%DA%AF%DB%8C_%D8%A7%D9%86%D8%B1%DA%98%DB%8C_%D9%85%DA%A9%D8%A7%D9%86%DB%8C%DA%A9%DB%8C)

### شبیه‌ساز خارجی
- [PhET — Energy Skate Park (فارسی موجوده)](https://phet.colorado.edu/fa/simulations/energy-skate-park-basics)

### روی همین سایت 🔗
- [نسخه‌ی ریاضی-فیزیک با اثبات‌های ریاضی](https://physicsme.ir/articles/payestegi-energy-mekaniki/)
